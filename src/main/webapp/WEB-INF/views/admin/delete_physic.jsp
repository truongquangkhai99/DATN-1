...
<html>
	<head>
		<title>Quản trị - Xóa tài khoản giảng viên vĩnh viễn</title>
			...
			<div class="row">
				...
				<div class="col-md-8">
					<div class="bs-example well">
						<form class="form-create" name='createForm' action="/admin/delete_physic" method="POST">
							...
							<c:if test="${success != null && success}">
								<div style="color: blue">Xóa vật lý giảng viên thành công</div>
							</c:if>
							<c:if test="${success != null && !success}">
